...
---
- The name of the router that the code is currently executing in is available as `import.meta.env.ROUTER_NAME`. This can be used to get the current router's manifest which harcoding a name in the code.
